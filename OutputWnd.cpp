...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// Create output panes:
	const DWORD dwStyle = LBS_NOINTEGRALHEIGHT | WS_CHILD | WS_VISIBLE | WS_HSCROLL | WS_VSCROLL | ES_MULTILINE | ES_AUTOHSCROLL | ES_AUTOVSCROLL |  ES_READONLY;
...
{
	m_wndOutputBuild.SetWindowTextW(_T("Welcome to Semi-Markov Modeller."));
}
...
COutputList* COutputWnd::GetOutputWindow(void)
{
	return &m_wndOutputBuild;
}

void COutputList::AppendText(CString szText)
{
