...
CClassView* CMainFrame::GetClassView()
{
	return &m_wndClassView;
}


COutputList* CMainFrame::GetOutputWindow()
{
	return m_wndOutput.GetOutputWindow();
}

CPropertiesWnd* CMainFrame::GetPropertiesWindow()
{
